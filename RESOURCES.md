...
- **Summary:** Describes practical techniques for structuring and maintaining context in agent systems, including prompt organization, memory boundaries, and strategies to manage long-running context.
- **How it’s used in this demo:** Influences how we structure prompts and manage retained context, complementing our compaction strategy for Databricks-hosted agents.
